...
if __name__ == "__main__":
    ...
    scores = eval_classwise(model, test_loader, logger, fallacy_ds.unique_labels, device)
    df = pd.DataFrame.from_records(scores, columns=['Fallacy Name', 'Precision', 'Recall', 'F1',
